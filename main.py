...
app = FastAPI(title='Backstract Generated APIs - coll-ebf6b2af25d84b28ae997eb6a5034ffb', debug=False,
              docs_url='/elegant-jaya-1fd7390ceab011ef8e440242ac12000593/docs',
              openapi_url='/elegant-jaya-1fd7390ceab011ef8e440242ac12000593/openapi.json')
...
app.include_router(
    router,
    prefix='/elegant-jaya-1fd7390ceab011ef8e440242ac12000593/api',
    tags=['APIs v1']
)
